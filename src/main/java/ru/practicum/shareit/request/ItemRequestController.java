...
public class ItemRequestController {
    ...
    @GetMapping("/all")
    public List<ItemRequestResponseDto> getAllRequests(@PositiveOrZero @RequestParam(defaultValue = "0") int from,
    ...
    @PostMapping
    public ItemRequestResponseDto addItemRequest(@Valid @RequestBody ItemRequestDto itemRequestDto,
                                                 @RequestHeader(USER_ID_HEADER) long userId) {
